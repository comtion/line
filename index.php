...
$strAccessToken = "kx69XWtVnoCV8eEUYvNDFV6gTni/05eN04EpSf3oE9pgzIk+MZx1uwrIHur4RSAihR/GVqHjc64rHosh/EQ3GrvLzoVhxzScExmQKg+zq4VgVphBIwU+Bn4cZfaZu2rtLLfg9J/9jcKsRCm364serQdB04t89/1O/w1cDnyilFU=";
 ...
 if($idcard!=""){
   ...
   if($countid == "13"){
	  ...
	  // require 'http://122.155.209.75/SPL888/linebot/check_arrest.php?operation=Add&a_cardid='.$idcard;
	   $ch = curl_init('http://122.155.209.75/SPL888/linebot/check_arrest.php?operation=Add&a_cardid='.$idcard);
